...
<!-- LOOP DO RAIN TPL --> <?php $counter1=-1;  if( isset($products) && ( is_array($products) || $products instanceof Traversable ) && sizeof($products) ) foreach( $products as $key1 => $value1 ){ $counter1++; ?>
                        <div class="single-product">
                            ...
                            <div class="product-carousel-price">
                                ...
                                <ins>R$<?php echo formatPrice($value1["vlprice"]); ?></ins> <!-- p/ promoção <del>$100.00</del> -->
                            </div>
                        </div>
  <!--FECHA LOOP -->    <?php } ?>
